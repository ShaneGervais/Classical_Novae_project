...
In this project we use the MESA software for simulating the stellar evolution during the classical novae process. We start by running MESA for three different mass exchange rates being $\dot{M} = $
